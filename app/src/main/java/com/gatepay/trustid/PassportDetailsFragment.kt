...
import com.gatepay.trustid.utils.StringUtils
    ...
    private fun refreshData(passport: Passport?) {
        ...
        if (sodFile != null) {
            ...
            if (docSigningCertificate != null) {
                ...
                try {
                    value_document_signing_certificate_thumbprint!!.text = StringUtils.bytesToHex(
