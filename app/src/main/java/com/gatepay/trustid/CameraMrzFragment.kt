...
import com.gatepay.trustid.mlkit.OcrMrzDetectorProcessor
import com.gatepay.trustid.utils.MRZUtil
                ...
                try {
                  ...
                  //  status_view_bottom!!.setTextColor(resources.getColor(R.color.status_text))
                    if (cameraMLKitCallback != null) {
                        ...
                        Log.i("CHECKING THE MRZ INFO", mrzInfo.documentNumber.toString())
                    }
...
//                    status_view_top!!.text = ""
    ...
    companion object {
         ...
         * Tag for the [Log].
         */
        private val TAG = CameraMrzFragment::class.java.simpleName

        private val REQUEST_CAMERA_PERMISSION = 1
        private val FRAGMENT_DIALOG = "CameraMLKitFragment"

        fun newInstance(): CameraMrzFragment {
            return CameraMrzFragment()
        }
    }
